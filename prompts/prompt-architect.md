...
- **`PROJECT-DOCS-TEMPLATES.md`**: Consolidated template for 4 essential documentation files
...
- **`step-project-overview.txt`**: Multi-file project documentation creation/update specialist
  - Generates all 4 documentation files in docs/ folder
...
- Multi-file documentation system with 4 essential files
...
1. Run `step-project-overview` → Generate/update 4 documentation files
...
- **Codebase scanning**: Automatic pattern detection with 4-file documentation system
...
1. Review generated planning documents and 4-file documentation system
...
- Ensure cross-file consistency across all 4 documentation files
...
This architecture provides a comprehensive, structured approach to LLM-assisted software development with streamlined 4-file documentation system, context-aware loading, and absolute dependency enforcement while maintaining flexibility and quality standards.
